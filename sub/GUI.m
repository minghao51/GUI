...
handles.I1 = imcrop(handles.data{1},handles.cropcor1);
imshow(handles.I1,[], 'Parent', handles.axes4) %displaying cropped portion of tumour
handles.I2 = imcrop(handles.data{1},handles.cropcor2);
imshow(handles.I2,[], 'Parent', handles.axes5) %displaying cropped portion of diaphram
...
if handles.CropV == 1;
    ...
    [handles.I1, cropcor1]= imcrop;
    
    imshow(handles.data{1},[])
    [handles.I2, cropcor2]= imcrop;
...
for cnt = 1 : numel(handles.dicomlist)
    ...
    handles.I1 = imcrop(handles.data{cnt},handles.cropcor1);
    handles.I2 = imcrop(handles.data{cnt},handles.cropcor2);
end
...
for cnt = 1 : numel(handles.dicomlist)
I2a{cnt} = threshold2(handles.I2{cnt},thresv,handles.cropcor1,...
    strelv,bwarea1,bwarea2,0,0,0,0,200);
I1a{cnt} = threshold2(handles.I1{cnt},thresv,handles.cropcor2,...
    strelv,bwarea1,bwarea2,0,0,0,0,200);
end
...
global I1 I2
imageout_t = handles.I1;
imageout_d = handles.I2;
